...
class VideoDetailsFragment : DetailsSupportFragment() {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        // Coil automatically handles request cancellation
    }

    private fun initializeBackground(movie: Movie?) {
        mDetailsBackground.enableParallax()
        val backgroundRequest = ImageRequest.Builder(requireContext())
            ...
            .build()
        requireContext().imageLoader.enqueue(backgroundRequest)
    }
    ...
    private fun setupDetailsOverviewRow() {
        ...
        val cardRequest = ImageRequest.Builder(requireContext())
            .data(mSelectedMovie?.cardImageUrl)
            .target { drawable ->
            ...
            .error(R.drawable.default_background)
            .build()
        requireContext().imageLoader.enqueue(cardRequest)
